...
namespace Solutions_DataProvider.Controllers
{
    ...
    public class GE3Controller : Controller, IEnvironment
    {
        ...
        {
            var resp = new DataProvider.DataAccess("ge3", region).Update(jsonToBeAdded.ToString());
            return resp;
        }
        ...
        {
            var data = new DataProvider.DataAccess("ge3", region, country).Get("info");
            return data;
        }
        ...
        {
            var data = new DataProvider.DataAccess("ge3", region, country).Get(param);
            return data;
        }
